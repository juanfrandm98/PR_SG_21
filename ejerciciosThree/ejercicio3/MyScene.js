...
//                                                                            //
// Mediante este ejercicio el alumno aprenderá a crear geometría por          //
// revolución a partir de una línea definida en un plano.                     //
// El vídeo geometria-revolucion.mp4 muestra un posible resultado del         //
// ejercicio.                                                                 //
// A tener en cuenta:                                                         //
// - La línea a revolucionar se define como un array de Vector3 con la z = 0  //
//   y se usa dicho array, tal cual, al crear la geometría por revolución.    //
//   Sin embargo, para crear y visualizar una línea, se debe asignar dicho    //
//   array al atributo vertices de una Geometry y después usar esa Geometry   //
//   al instanciar la clase Line.                                             //
//        // Puntos                                                           //
//        points = [];                                                        //
...
class MyScene extends THREE.Scene {
    ...
    constructor(myCanvas) {
        ...
        points.push(new THREE.Vector3(3, -5, 0));
        points.push(new THREE.Vector3(3, -4, 0));
        points.push(new THREE.Vector3(1.5, -4, 0));
        points.push(new THREE.Vector3(1, -3, 0));
        points.push(new THREE.Vector3(1, 2, 0));
        points.push(new THREE.Vector3(1.5, 2.75, 0));
        points.push(new THREE.Vector3(2, 3.5, 0));
        points.push(new THREE.Vector3(1.5, 4.25, 0));
        points.push(new THREE.Vector3(0, 5, 0));

        this.peon = new MyRevolObj(points, this.gui, 'Controles del peón');
        this.add(this.peon);

        this.linea = new MyLine(points, this.gui, 'Controles de la línea');
        this.linea.position.x = -10;
        this.add(this.linea);
